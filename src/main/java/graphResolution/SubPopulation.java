...
public class SubPopulation {
	...
	public SubPopulation(boolean halfSeparation) {
		for(int i=0; i<Constants.POPULATIONSIZE; i++) population.add(new Individual());
		this.halfSeparation=halfSeparation;
	}
	
	public SubPopulation(SubPopulation previousPopulation) {
		this.population = previousPopulation.population;
		this.halfSeparation=previousPopulation.halfSeparation;
	}
	
	public SubPopulation(ArrayList<Individual> population) {
		this(population,true);
	}
	
	public SubPopulation(ArrayList<Individual> population, boolean halfSeparation) {
